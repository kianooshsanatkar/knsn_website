        ...
        <Grid container>
          ...
          <Grid item sm={6}>
            ...
            <Typography variant="body1" align="left">
              I just mentioned some technologies and tools that I like most to
              work on, but it doesn’t mean that I would not work on any other
              stuff, please feel free to ask me about any idea or job you would
              like to be done.
            </Typography>
          </Grid>
          <Grid item sm={2}></Grid>
